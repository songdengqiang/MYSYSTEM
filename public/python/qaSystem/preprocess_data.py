...
class Question():
    ...
    def init_config(self):
        ...
        # 读取问题模板
        with(open("./public/python/qaSystem/data/question/question_classification.txt","r",encoding="utf-8")) as f:
    ...
    def question_posseg(self):
        jieba.load_userdict("./public/python/qaSystem/data/userdict3.txt")
